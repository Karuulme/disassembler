...
public:
    ...
    void    CalculationR(Operands * operands,BYTE registerOpcodeFiled);
    void    CalculationEffectiveAddress(Operands * operands,BYTE registerOpcodeFiled);
    void    CalculationSib(Operands * operands,BYTE registerOpcodeFiled);
    __int8  CalculationSS(BYTE* byte);
